# Generated by Powerlevel10k configuration wizard on 2024-02-02 at 00:11 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context                 # computers science contexte (git, etc)
    command_execution_time  # time taken by the command
